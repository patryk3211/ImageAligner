...
int main() {
  ...
  auto seqPtr = Sequence::readStream(istr);
  auto& seq = *seqPtr;

  if(!check_header(seq, "test_sequence", 0, 3, 2, 0, 1, 4, 0, 0))
    return 1;

  if(seq.getSequenceType() != SequenceType::SINGLE_FITS)
    return 1;
  if(seq.getLayerCount() != 3)
    return 1;
  ...
  if(!check_stats(*seq.image(0)->getStats(0), 12144384, -1, -101, -102, -103, -104, -105, -106, -107, -108, 990, 3889, 65535, -1000))
    return 1;
  if(!check_stats(*seq.image(0)->getStats(1), 12144384, -1, -999999, -999999, -999999, -999999, -999999, -999999, -999999, -999999, 1046, 2317, 65535, -999999))
    return 1;
  if(!check_stats(*seq.image(0)->getStats(2), 12144384, -1, -999999, -999999, -999999, -999999, -999999, -999999, -999999, -999999, 1006, 1603, 65535, -999999))
    return 1;

  if(!check_registration(*seq.image(0)->getRegistration(), 0, 1, 2, 3, 4, 5, 10, 11, 12, 13, 14, 15, 16, 17, 18))
    return 1;
